...
pub fn citation() {
    println!("Bajdek, P., 2022. coprosize (version 1.0.2). [computer software] https://github.com/piotrbajdek/coprosize");
}
...
pub fn carnivorous_amniota(diameter: &str) {
    ...
    let power = f64::powf(dcal as f64, 2.4839053017);
...
pub fn carnivorous_amphibia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power1 = f64::powi(dcal as f64, 3);
    let power2 = f64::powi(dcal as f64, 2);
    let mass = 0.0147514015f64.mul_add(dcal, (0.0004064349 * power1) - (0.0041616775 * power2)) - 0.0122201640;
...
pub fn carnivorous_archosauria(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.3933363596);
...
pub fn carnivorous_felidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 3.7646426827);
...
pub fn carnivorous_mammalia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.6010376216);
...
pub fn carnivorous_squamata(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.3414629141);
...
pub fn carnivorous_tetrapoda(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.6157600696);
...
pub fn herbivorous_afrotheria(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.7889164772);
...
pub fn herbivorous_amniota(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.2123196655);
...
pub fn herbivorous_artiodactyla(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.3109191553);
...
pub fn herbivorous_aves(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.8100206869);
...
pub fn herbivorous_bovidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.1885588774);
...
pub fn herbivorous_cervidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 3.4595227094);
...
pub fn herbivorous_lagomorpha(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.3225288441);
...
pub fn herbivorous_mammalia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.1815554929);
...
pub fn herbivorous_marsupialia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.2193247015);
...
pub fn herbivorous_placentalia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.2424443852);
...
pub fn herbivorous_reptilia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.8272692414);
...
pub fn herbivorous_rodentia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.2974489103);
...
pub fn omnivorous_amniota(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.2146716042);
...
pub fn omnivorous_artiodactyla(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 1.0887395414);
...
pub fn omnivorous_aves(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 3.0157553176);
...
pub fn omnivorous_mammalia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.0562969771);
...
pub fn omnivorous_rodentia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 1.6780088221);
...
pub fn unspecified_canidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.0396557894);
...
pub fn unspecified_carnivora(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.8590076963);
...
pub fn unspecified_cricetidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(1.8766049284, dcal as f64);
    ...
    print!("{:.3}", mass);
    print!(" kg{}", reset.to_owned());
    println!(" = 0.0180745732 * 1.8766049284{}", dmpw + cyan);
...
pub fn unspecified_herpestidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(1.0767216732, dcal as f64);
    ...
    print!("{:.3}", mass);
    print!(" kg{}", reset.to_owned());
    println!(" = 0.3503054969 * 1.0767216732{}", dmpw + cyan);
...
pub fn unspecified_marsupialia(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.1922202080);
...
pub fn unspecified_mustelidae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.5225036146);
...
pub fn unspecified_sciuridae(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(1.7069919381, dcal as f64);
    ...
    print!("{:.3}", mass);
    print!(" kg{}", reset.to_owned());
    println!(" = 0.0384600726 * 1.7069919381{}", dmpw + cyan);
...
pub fn unspecified_testudines(diameter: &str) {
    ...
    let dcal: f64 = diameter.parse().expect(&(red.to_owned() + "Incorrect diameter value! Program only processes numbers!" + reset));
    let power = f64::powf(dcal as f64, 2.1345692041);
